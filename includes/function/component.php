    ...
    <div class="views-row col-lg-2 col-md-4 col-sm-6 book-box col-6">
        <div class="category-box d-flex justify-content-center align-content-center align-items-center flex-wrap border rounded">
            ...
            <ul class="book-links text-center">
                ...
                <li><a style="border: 1px solid" id="edit_icon" href="' . $section["edit_url"] . '" data-tip="' . $section["edit_txt"] . '"><i class="fa-duotone fa-pen"></i></a></li>
            </ul>
        </div>
    </div>';
    echo $category;
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-evenly">
                    <button type="button" id="delete_btn" class="btn upper-btn rounded-pill btn-logout" onclick="' . $url . '">' . lang('delete') . '</button>
                    <button type="button" class="btn upper-btn rounded-pill btn-cancel" data-bs-dismiss="modal">' . lang('close') . '</button>
                </div>
            </div>
        </div>
    </div>
...
// add category popup
function add_cat($action = 'add_category.php', $cat_name = '', $cat_id = '')
{
    if (!empty($cat_id))
        $cat_id_input = '<input type="hidden" name="cat_id" value="' . $cat_id . '">';
            ...
            <form action="' . $action . '" method="POST" class="needs-validation" novalidate>
                <div class="modal-body mx-5 px-4 mb-4">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" required value="' . htmlentities($cat_name) . '" class="form-control " name="cat_name" id="cat_name" placeholder="' . lang('category_placeholder') . '" >
                        <div class="valid-feedback">' . lang("fill_category_valid") . '</div>
                        <div class="invalid-feedback">' . lang("fill_category_error") . '</div>
                    </div>
                    <!-- for update -->
                    ' . $cat_id_input . '
                </div>
                <div class="modal-footer  justify-content-evenly">
                    <input type="submit" class="add btn btn-primary" value="' . lang('add') . '" />
                    <button type="button" class="cancel btn btn-secondary" data-bs-dismiss="modal">' . lang('cancel') . '</button>
                </div>
            </form>
        </div>
        </div>
