...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($_POST["email"]) || empty($_POST["password"])) {
        $result = " <div class='alert alert-danger'>" . lang('login_empty') . "</div>";
        // return;
    } else {
        ...
        $userEmail = filter_var($user, FILTER_VALIDATE_EMAIL, FILTER_NULL_ON_FAILURE);
        ...
        if (!empty($userEmail) && !empty($password)) {
            ...
            if ($results != 0) {
                ...
                $result = " <div class='alert alert-danger'>" . lang('login_error') . "</div>";
                }
            } else {
                $result = " <div class='alert alert-danger'>" . lang('login_error') . "</div>";
            }
...
<div class="containerElement mt-5 loginpage d-flex align-items-center justify-content-center">
